-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'CURADOR', 'ORG_ADMIN', 'ORG_MEMBER');
...
-- CreateIndex
CREATE INDEX "Domain_grouping_idx" ON "Domain"("grouping");

-- CreateIndex
CREATE UNIQUE INDEX "Domain_grouping_key_key" ON "Domain"("grouping", "key");
