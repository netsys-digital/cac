  ...
  try {
    ...
    res.json({
      items: items.map((o) => ({
        ...
        technologyBannerUrl: o.technologyBannerUrl,
        challengeBannerUrl: o.challengeBannerUrl,
        fundingOfferBannerUrl: o.fundingOfferBannerUrl,
        successCaseBannerUrl: o.successCaseBannerUrl,
        technologyBannerLinkUrl: o.technologyBannerLinkUrl,
        challengeBannerLinkUrl: o.challengeBannerLinkUrl,
        fundingOfferBannerLinkUrl: o.fundingOfferBannerLinkUrl,
        successCaseBannerLinkUrl: o.successCaseBannerLinkUrl,
        technologyBannerPosition: o.technologyBannerPosition,
        challengeBannerPosition: o.challengeBannerPosition,
        fundingOfferBannerPosition: o.fundingOfferBannerPosition,
        successCaseBannerPosition: o.successCaseBannerPosition,
      })),
    });
  } catch (error) {
    next(error);
