export const es = {
  ...
  home: {
    ...
    aboutBadge: '¿Qué es CAC?',
    aboutTitle: 'Un ecosistema global por soluciones climáticas reales',
    aboutBody:
      'Climate Action Connect conecta a quienes enfrentan desafíos climáticos con quienes ofrecen soluciones, financiamiento y evidencia — con curaduría y gobernanza.',
    aboutCta: 'Conozca más sobre CAC',
    pillars: [
      {
        title: 'Conexión',
        body: 'Acerque demandas, ofertas y financiadores en un solo lugar.',
      },
      {
        title: 'Colaboración',
        body: 'Construya puentes entre investigación, territorio e implementación.',
      },
      {
        title: 'Conocimiento',
        body: 'Acceda a soluciones, proyectos y casos con contexto y madurez.',
      },
      {
        title: 'Impacto',
        body: 'Transforme la búsqueda en caminos de acción medibles.',
      },
    ],
