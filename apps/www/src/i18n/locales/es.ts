export const es = {
  ...
  detail: {
    ...
    favorited: 'En mis favoritos',
    favoriteError: 'No se pudo marcar como favorito. Inténtelo de nuevo.',
    favoriteLoginHint:
      'Para marcar favoritos, necesita ser miembro registrado. Inicie sesión o cree una cuenta.',
    ...
    actions: 'Acciones',
    actionsHint: 'Para realizar conexiones o marcar favoritos, necesita ser miembro registrado.',
  ...
  challengeLanding: {
    ...
    whySupport:
      'Al publicar un desafío, amplía sus posibilidades de encontrar soluciones innovadoras y acelera el impacto en el campo.',
    why1Title: 'Encuentre soluciones',
    why1Body: 'Conéctese con especialistas, startups e instituciones con experiencia real.',
    why2Title: 'Amplíe su red',
    why2Body: 'Acerque socios estratégicos y potenciales financiadores.',
    why3Title: 'Acelere la innovación',
    why3Body: 'Transforme necesidades en oportunidades de colaboración.',
    why4Title: 'Genere impacto',
    why4Body: 'Contribuya a un agro más productivo, sostenible e inclusivo.',
    howTitle: '¿Cómo funciona?',
    howSupport: 'En pocos pasos, su desafío puede alcanzar toda la red AgriZONE CONNECT.',
    how1Title: 'Describa el desafío',
    how1Body: 'Informe el contexto, objetivos y áreas relacionadas.',
    how2Title: 'Publique',
    how2Body: 'Su desafío quedará visible en la plataforma.',
    how3Title: 'Conéctese',
    how3Body: 'Reciba propuestas y contacte a interesados.',
    how4Title: 'Transforme',
    how4Body: 'Colabore, implemente soluciones y genere resultados.',
    ctaTitle: '¿Listo para el próximo paso?',
    ctaBody: 'Publique ahora su desafío y conéctese con quien puede transformar su demanda en solución.',
  },
  offerLanding: {
    badge: '04 • OFREZCA',
    title: 'Ofrezca',
    support: 'Gane visibilidad para tecnologías, proyectos y conocimientos listos para conectar a desafíos y financiamiento.',
    publishCta: 'Publicar una solución',
  },
  funding: {
