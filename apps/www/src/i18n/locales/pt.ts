export const pt = {
  ...
  detail: {
    ...
    favoriting: 'Salvando…',
    favorited: 'Nos meus favoritos',
    favoriteError: 'Não foi possível favoritar. Tente de novo.',
    favoriteLoginHint:
      'Para favoritar, você precisa ser membro registrado. Faça login ou crie uma conta.',
    ...
    actions: 'Ações',
    actionsHint:
      'Para realizar conexões ou favoritar, você precisa ser membro registrado.',
  ...
  challengeLanding: {
    ...
    whySupport:
      'Ao publicar um desafio, você amplia suas chances de encontrar soluções inovadoras e acelera o impacto no campo.',
    why1Title: 'Encontre soluções',
    why1Body: 'Conecte-se a especialistas, startups e instituições com experiência real.',
    why2Title: 'Amplie sua rede',
    why2Body: 'Aproxime-se de parceiros estratégicos e potenciais financiadores.',
    why3Title: 'Acelere a inovação',
    why3Body: 'Transforme necessidades em oportunidades de colaboração.',
    why4Title: 'Gere impacto',
    why4Body: 'Contribua para um agro mais produtivo, sustentável e inclusivo.',
    howTitle: 'Como funciona?',
    howSupport: 'Em poucos passos, seu desafio pode alcançar toda a rede AgriZONE CONNECT.',
    how1Title: 'Descreva o desafio',
    how1Body: 'Informe o contexto, objetivos e áreas relacionadas.',
    how2Title: 'Publique',
    how2Body: 'Seu desafio ficará visível na plataforma.',
    how3Title: 'Conecte-se',
    how3Body: 'Receba propostas e entre em contato com interessados.',
    how4Title: 'Transforme',
    how4Body: 'Colabore, implemente soluções e gere resultados.',
    ctaTitle: 'Pronto para dar o próximo passo?',
    ctaBody: 'Publique agora seu desafio e conecte-se a quem pode transformar sua demanda em solução.',
  },
  offerLanding: {
    badge: '04 • OFEREÇA',
    title: 'Ofereça',
    support: 'Ganhe visibilidade para tecnologias, projetos e conhecimentos prontos para conectar a desafios e financiamento.',
    publishCta: 'Publicar uma solução',
  },
  funding: {
